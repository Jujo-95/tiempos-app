...
import 'package:tiempos_app/app/ui/views/tables/manage_invoices_table.dart';

class ManageInvoicesTab extends StatefulWidget {
  final Stream<QuerySnapshot<Object?>> invoicesStream;

  const ManageInvoicesTab({Key? key, required this.invoicesStream})
      : super(key: key);

  @override
  ManageInvoicesTabState createState() => ManageInvoicesTabState();
}

class ManageInvoicesTabState extends State<ManageInvoicesTab> {
  ...
  Widget build(BuildContext context) {
    ...
    return Column(
      children: [
        ...
        Expanded(
            child: ManageInvoicesTable(
          stream: widget.invoicesStream,
...
class _DropdownMenuImportCsvAccountsState
  ...
  void _openActivityForm(BuildContext context) {
    return CentralDialogForm.openEditForm(context, InvoiceForm());
  }
