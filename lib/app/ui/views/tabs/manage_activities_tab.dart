...
import 'package:tiempos_app/app/ui/views/tables/manage_activities_table.dart';

class ManageActivitiesTab extends StatefulWidget {
  final Stream<QuerySnapshot<Object?>> operationsStream;
  final Stream<QuerySnapshot<Object?>> activitiesStream;

  const ManageActivitiesTab(
      {Key? key,
  ...
  @override
  ManageActivitiesTabState createState() => ManageActivitiesTabState();
}

class ManageActivitiesTabState extends State<ManageActivitiesTab> {
  ...
  Widget build(BuildContext context) {
    Widget headerWebUI = Row(
      ...
      children: [
        ...
        const Expanded(
          ...
          child: Padding(
            padding: EdgeInsets.all(28),
            child: DropdownMenuImportCsvActivities(),
          ),
        ),
      ],
    );
    ...
    return Column(
      children: [
        ...
        Expanded(
            child: ManageActivityTable(
          activitiesStream: widget.activitiesStream,
          operationsStream: widget.operationsStream,
...
class DropdownMenuImportCsvActivities extends StatefulWidget {
  const DropdownMenuImportCsvActivities({super.key});
...
class _DropdownMenuImportCsvActivitiesState
  ...
  void _openActivityForm(BuildContext context) {
    return CentralDialogForm.openEditForm(context, const ActivityForm());
  }
